...
import 'package:eshop_multivendor/validation/form_validation.dart';
...
class StateAddress extends State<AddAddress> with TickerProviderStateMixin {
  ...
  void initState() {
   ...
   // callApi();
    ...
    altmobileNambe = new TextEditingController();
    ...
    if (widget.update!) {
      ...
      altmobileNambe!.text = item.altMob ?? "";
      emailC!.text = item.email ?? "";
        ...
        child: Padding(
          ...
          child: TextFormField(
            ...
            style: Theme.of(context)
                ...
                .copyWith(color: Theme.of(context).colorScheme.fontColor),
            validator: (value) {
              if (altmobileNambe!.text.isNotEmpty) {
                if (altmobileNambe!.text.length != 10)
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => PlacePicker(
                          ...
                          initialPosition: loc.lat!=null?LatLng(double.parse(loc.lat.toString()), double.parse(loc.lng.toString())):LatLng(20.5937,78.9629),
                      ...
                      onPressed: () async {
                       ...
                       /* Position position = await Geolocator.getCurrentPosition(
                        ...
                        if (mounted) {
                          if(result!=null){
                            setState(() {
                              countryC!.text = result.first.subAdminArea;
                              stateC!.text = result.first.adminArea;
                              latitude = result.first.coordinates.latitude.toString();
                              longitude = result.first.coordinates.longitude.toString();
                              landmarkC!.text = result.first.subLocality;
                              addressC!.text = result.first.addressLine;
                            });
                          }
      ...
      child: Container(
        ...
        child: Padding(
            ...
            child: TextFormField(
              ...
              decoration: InputDecoration(
                  // label: Text(getTranslated(context, "PINCODEHINT_LBL")!),
                  label: Text('flat no , apartment name , landmark'),
                  fillColor: Theme.of(context).colorScheme.white,
                  isDense: true,
                  hintText: "flat no , apartment name , landmark",
                  // hintText: getTranslated(context, 'PINCODEHINT_LBL'),
                  border: InputBorder.none),
            )),
      ),
  ...
  Future<void> addNewAddress() async {
    ...
    try {
      var data = {
        ...
        // AREA_ID: area,
        "alternate_mobile":
            altmobileNambe!.text.isNotEmpty ? altmobileNambe!.text : "",
        "landmark": landmarkC!.text.isNotEmpty ? landmarkC!.text : "",
        ADDRESS: address,
        "email": emailC!.text.isNotEmpty ? emailC!.text : "",
        // STATE: state,
        // COUNTRY: country,
        TYPE: type,
                        ...
                        children: <Widget>[
                          Selector<UserProvider, String>(
                              ...
                              builder: (context, userName, child) {
                                nameC = TextEditingController(text: userName);
                       return   setUserName();
  }),
        Selector<UserProvider, String>(
            selector: (_, provider) => provider.mob,
            builder: (context, userMobile, child) {
              mobileC = TextEditingController(text: userMobile);
              return setMobileNo();
            }),
