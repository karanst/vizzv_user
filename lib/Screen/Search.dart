        ...
        appBar: AppBar(
          ...
          title: TextField(
            ...
            decoration: InputDecoration(
              ...
              hintText: widget.type!=null?widget.type=="Product"?"Search Products":"Search Restaurants":"Search With Shop Name",
 ...
 /*   if (_controllerList.length < index + 1)
        ...
        child: InkWell(
          child: Stack(
            children: [
                ...
                children: <Widget>[
                  Hero(
                      ...
                      child: ClipRRect(
                          ...
                          child: commonHWImage( productList[index].image.toString(),80.0,80.0,"",context,"assets/images/placeholder.png")),
                         ),
                  Expanded(
                    child: Padding(
              ...
              loading&&selectedIndex==index?Center(child: CircularProgressIndicator()):SizedBox(),
          ...
          onTap: () {
            ...
            getSeller(productList[index].seller_id);
            /*Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => SellerProfile(
                      ...
                      sellerImage:
                      "$imageUrl${sellerLists[index]["logo"]}",
                      sellerStoreName: sellerLists[index]
                      ["store_name"],
                      storeDesc: sellerLists[index]
                      ["store_description"] ??
                          "",
  ...
  void getAvailVarient(List<Product> tempList) {
    for (int j = 0; j < tempList.length; j++) {
      ...
      print(tempList[j].seller_id);
      print(tempList[j].store_name);
    }
        ...
        Padding(
          ...
          child: productList.length>0?ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return item == null ? Container() :item.prVarientList!=null?listItem(index):Container();
              }):SizedBox(),
        ),
  ...
  _showRest() {
    return
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        child: commonImage("$imageUrl${sellerLists[index]["logo"]}","",context,"assets/images/placeholder.png")),
                ),
                ...
                trailing: sellerLists[index]["open_close_status"] == "1"
                    ? Text(
                  "Open",
