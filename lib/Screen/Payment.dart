...
class Payment extends StatefulWidget {
  ...
  Payment(this.update, this.msg, this.totalPrice);
...
class StatePayment extends State<Payment> with TickerProviderStateMixin,AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        leading: Builder(builder: (BuildContext context) {
          return Container(
            ...
            child: InkWell(
              ...
              onTap: () =>  Navigator.pop(context, payMethod),
              child: Center(
                child: Icon(
      ...
      // getSimpleAppBar(getTranslated(context, 'PAYMENT_METHOD_LBL')!,
                  ...
                  child: Column(
                    children: [
                      ...
                      SimBtn(
                        ...
                        onBtnSelected: () {
                          Navigator.pop(context,payMethod);
                        },
                      ),
                    ],
                  ),
      ...
      try {
        ...
        if (response.statusCode == 200) {
          ...
          if (!error) {
            ...
            cashfree = payment["cash_free"] == "1" ? true : false;
            ...
            if (cashfree)
              {
                cashfreeId = payment["cash_free_key_id"];
                cashfreeKey = payment["cash_free_secret_key"];
              }
            if (paystack) {
            ...
            if(MAX_AMOUNT!=''&&double.parse(widget.totalPrice.toString())>double.parse(MAX_AMOUNT.toString())){
                cod = false;
            }
