                      ...
                      child: Column(
                          ...
                          children: <Widget>[
                           ...
                           Padding(
                              ...
                              child: Row(
                                children: [
                                  Icon(Icons.check_circle,color: proStatus==DELIVERD||searchList[index].payMethod.toString()!="COD"?Colors.green:Colors.red,),
                                  AnimatedTextKit(
                                    animatedTexts: [
            ...
            final result = await Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) => OrderDetail(
                        ...
                        orderId: searchList[index].itemList![0].varientId,
                      )),
            );
