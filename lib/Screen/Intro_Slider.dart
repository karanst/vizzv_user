...
class _GettingStartedScreenState extends State<IntroSlider>
  ...
  skipBtn() {
    return _currentPage == 0 || _currentPage == 1
        ? Padding(
            padding: EdgeInsetsDirectional.only(top: 20.0, end: 10.0, bottom: 10.0),
            child: Row(
