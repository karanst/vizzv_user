...
class _ItemSearchState extends State<ItemSearch> with TickerProviderStateMixin {
        ...
        appBar: AppBar(
          ...
          title: TextField(
            ...
            decoration: InputDecoration(
              ...
              hintText: "Search Product in ${widget.title}",
        ...
        Padding(
          ...
          child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return item == null ?
                Container() :
                productList[index].prVarientList!=null&&productList[index].prVarientList!.length>0 ? listItem(index) : SizedBox();
              }),
        ),
        //todo restaurant
        _SuggestionList(
