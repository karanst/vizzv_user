...
setSnackbar1(String msg, BuildContext context) {
  ScaffoldMessenger.of(context).showSnackBar(new SnackBar(
    content: new Text(
      msg,
      textAlign: TextAlign.center,
...
double calculateDistance(late1, lone1, late2, lone2){
  double lat1,lat2,lon1,lon2;
  print("$late1 $late2 $lone1 $lone2");
  if(late1!=null&&late2!=null&&lone1!=null&&lone2!=null&&late1!=""&&late2!=""&&lone1!=""&&lone2!=""){
