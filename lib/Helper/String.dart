...
final Uri getFavouriteSeller = Uri.parse(baseUrl + 'getSellerFavorites');
final Uri addFavoritSeller = Uri.parse(baseUrl + 'add_to_favoritesSeller');
final Uri getSellerRatingsApi = Uri.parse(baseUrl + 'get_seller_rating_data');
final Uri removeFavoritSeller =
    Uri.parse(baseUrl + 'removeSeller_from_favorites');
final Uri getSellerApi = Uri.parse(baseUrl + 'get_sellers');
final Uri getTopSellerApi = Uri.parse(baseUrl + 'top_five_sellers');
final Uri getOneSellerApi = Uri.parse(baseUrl + 'get_seller');
...
final Uri getSubCatBySellerId = Uri.parse(baseUrl + 'subcategories');
...
final Uri updateUserLatLongApi = Uri.parse(baseUrl + 'update_lat_lang_user');
final Uri manageCartApi = Uri.parse(baseUrl + 'manage_cart');
final Uri addCartApi = Uri.parse(baseUrl + 'add_to_cart');
final Uri recommendedProductapi = Uri.parse(baseUrl + 'recommend_product');
final Uri moreProductApi = Uri.parse(baseUrl + 'recommend_product_details');
final Uri subProductApi = Uri.parse(baseUrl + 'get_products_by_sub');
final Uri getUserLoginApi = Uri.parse(baseUrl + 'login_with_otp');
final Uri getExtraDeliveryChargesApi = Uri.parse(baseUrl + 'get_address_by_delevery_charge');
...
final Uri reOrderApi = Uri.parse(baseUrl + 'get_reorder_data');
// final String reOrderApi = 'get_reorder_data';
...
final Uri deliveryCharge = Uri.parse(baseUrl + "get_delivery_charge_distacee");
final Uri getKmsApi = Uri.parse(baseUrl + "calculate");
final Uri getDeliveryRadiusUrl = Uri.parse(baseUrl + "check_delivery");
final Uri addSellerRating = Uri.parse(baseUrl + "add_seller_rating");
final Uri freeFoodDelivery = Uri.parse(baseUrl + "getFreeFoodDeliveryProducts");
final Uri singleSeller = Uri.parse(baseUrl + "get_sellers_view");
final Uri getFreeFoodDeliverySeller = Uri.parse(baseUrl + "getFreeFoodDeliverySeller");
final Uri getFreeFoodDeliveryProducts = Uri.parse(baseUrl + "getFreeFoodDeliveryProducts");
final Uri clear_cart_by_user = Uri.parse(baseUrl + "clear_cart_by_user");
final Uri ngo_donate_food = Uri.parse(baseUrl + "ngo_donate_food");
final Uri ngo_donate_food_get = Uri.parse(baseUrl + "ngo_donate_food_get");
final Uri checkShopInCart = Uri.parse(baseUrl + "get_cart_seller_status");
